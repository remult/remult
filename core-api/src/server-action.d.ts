...
export declare function DescribeStaticBackendMethod(cls: any, methodName: string, options: BackendMethodOptions<any>, paramTypes?: any[]): void;
export declare function DescribeBackendMethod(cls: any, methodName: string, options: BackendMethodOptions<any>, paramTypes?: any[]): void;
