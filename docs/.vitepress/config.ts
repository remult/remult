    ...
    nav: [
      ...
      },
      {
        ...
        items: tutorials.map(t => ({
          text: (t.title ?? t.path).charAt(0).toUpperCase() + (t.title ?? t.path).slice(1),
      ...
      tutorials.reduce((a, t) => {
        a[`/tutorials/${t.path}/`] = [{
          ...
          items: [
            ...
            { text: "Paging, Sorting and Filtering", link: `/tutorials/${t.path}/sorting-filtering` },
            { text: "CRUD Operations", link: `/tutorials/${t.path}/crud` },
            { text: "Validation", link: `/tutorials/${t.path}/validation` },
            { text: "Live Queries 🚀", link: `/tutorials/${t.path}/live-queries` },
            { text: "Backend methods", link: `/tutorials/${t.path}/backend-methods` },
            { text: "Authentication and Authorization", link: `/tutorials/${t.path}/auth` },
        ...
        '/blog/': [
          {
            ...
            items: [
              { text: "Introducing Remult", link: '/blog/introducing-remult-part-1' }
            ]
          }
        ]
      }),
