...
- **Breaking Change** Changed the POST rest api queries to include the filter under the `where` key in the body - previosly it included the filter as the body itself.
