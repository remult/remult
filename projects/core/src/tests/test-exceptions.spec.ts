...
import { Field, Entity, EntityBase, StringField } from '../remult3';
...
describe("angular http client exception ", () => {
    it("waiting for proxy to restart", async () => {
        let err = await processHttpException({
            ...
            "message": "Http failure response for http://localhost:4201/api/stam: 504 Gateway Timeout",
    ...
    it("Forbidden", async () => {
        let err = await processHttpException({
            ...
            "ok": false,
            "name": "HttpErrorResponse",
            "message": "Http failure response for http://localhost:4201/api/stam: 403 Forbidden",
            "error": "Forbidden"
        });
        expect(err).toEqual({
            "message": "Forbidden"
    ...
    it("syntax error", async () => {
        let err = await processHttpException({
            ...
            "ok": false,
            "name": "HttpErrorResponse",
            "message": "Http failure response for http://localhost:4201/api/stam: 400 Bad Request",
            "error": {
