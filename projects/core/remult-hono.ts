...
import { RouteImplementation, type ServerCoreOptions } from './server/remult-api-server.js'
import type { ResponseRequiredForSSE } from './SseSubscriptionServer.js'
import { parse, serialize } from './src/remult-cookie.js'

class HonoRouteImplementation extends RouteImplementation<Context<Env, '', BlankInput>> {
  constructor(
    private app: Hono,
  ...
  private createHonoRoute(
    ...
    methodMap?: Map<string, GenericRequestHandler<Context<Env, '', BlankInput>>>,
  ): SpecificRoute<Context<Env, '', BlankInput>> {
